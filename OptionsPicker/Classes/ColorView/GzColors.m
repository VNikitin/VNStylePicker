...
+ (NSString*)hexFromColor:(UIColor*)aColor {
    if (CGColorGetNumberOfComponents(aColor.CGColor) < 4) {
        const CGFloat *components = CGColorGetComponents(aColor.CGColor);
        aColor = [UIColor colorWithRed:components[0] green:components[0] blue:components[0] alpha:components[1]];
    }
    if (CGColorSpaceGetModel(CGColorGetColorSpace(aColor.CGColor)) != kCGColorSpaceModelRGB) {
        return [NSString stringWithFormat:@"#FFFFFF"];
    }
    return [NSString stringWithFormat:@"#%02X%02X%02X", (int)((CGColorGetComponents(aColor.CGColor))[0]*255.0), (int)((CGColorGetComponents(aColor.CGColor))[1]*255.0), (int)((CGColorGetComponents(aColor.CGColor))[2]*255.0)];
}
@end
